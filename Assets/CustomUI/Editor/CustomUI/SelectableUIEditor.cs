...
namespace Custom.UI
{
    ...
    public class SelectableUIEditor : Editor
    {
        ...
        GUIContent m_VisualizeNavigation = new GUIContent("Navigation");
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (graphic == null)
                graphic = (target as SelectableUI).GetComponent<Graphic>();
        ...
        protected static UnityEditor.Animations.AnimatorController GenerateSelectableAnimatorContoller(AnimationTriggers animationTriggers, SelectableUI target)
        {
            if (target == null)
                return null;
        ...
        private static string GetSaveControllerPath(SelectableUI target)
        {
        ...
        private static string BuildAnimationPath(SelectableUI target)
        {
        ...
        private static void StaticOnSceneGUI(SceneView view)
        {
            ...
            for (int i = 0; i < SelectableUI.allSelectables.Count; i++)
            {
                DrawNavigationForSelectable(SelectableUI.allSelectables[i]);
            }
        }
        ...
        private static void DrawNavigationArrow(Vector2 direction, SelectableUI fromObj, SelectableUI toObj)
        {
