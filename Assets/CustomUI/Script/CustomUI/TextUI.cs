...
namespace Custom.UI
{
    ...
    [AddComponentMenu("CustomUI/TextUI", 21)]
    public class TextUI : MaskableGraphic, ILayoutElement
    {
        ...
        public Font font
        {
            ...
            set
            {
                ...
                FontUpdateTrackerUI.UntrackText(this);

                m_FontData.font = value;

                FontUpdateTrackerUI.TrackText(this);
